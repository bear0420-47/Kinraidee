...
Read `AGENTS.md`, `docs/01-requirements/intent.md`, every current specification under `docs/01-requirements/01-spec/`, `docs/01-requirements/backlog.md`, `evidence/survey-summary.md`, and `rule.md`.
